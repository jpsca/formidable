...
Formidable fields come with a few methods to help you write less HTML. You don't need to use them, you can always write your HTML by hand using the attributes below, but they are very useful in most situations.
...
Tired of calling the helpers methods for label, input, and error tag, all the time? You can make it even shorter with the `field.render()` helper:
